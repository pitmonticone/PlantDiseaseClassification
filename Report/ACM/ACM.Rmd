...
```{r input-images, echo=FALSE, fig.align='center', fig.cap="Sample of training images.", fig.width=100, fig.height=40, message=FALSE, warning=FALSE, paged.print=FALSE}
library(knitr)
include_graphics("Images/InputImages.png")
```


```{r pre-smote, echo=FALSE, fig.align='center', fig.cap = "Pre-`SMOTE` truncated SVD.", fid.width=450, fid.height=450, message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/TruncatedSVD_preSMOTE.png")
```

```{r post-smote, echo=FALSE, fig.align='center', fig.cap="Post-`SMOTE` truncated SVD.", fid.width=450, fid.height=450, message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/TruncatedSVD_postSMOTE.png")
```
```{r ae, echo=FALSE, fig.align='center', fig.cap='Schematic representation of the convolutional autoencoder.', fid.width=350, fid.height=500, message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/AEShort.png")
```
```{r basenet, echo=FALSE, fig.align='center', fig.cap='**FIGURE 5.** Schematic representation of the selected model architecture.', fid.width=350, fid.height=500, message=FALSE, warning=FALSE, paged.print=FALSE}

include_graphics("Images/BaseNetShort.png")
```
```{r confusion-matrices, echo=FALSE, fig.align='center', fig.cap='**FIGURE 6.** Confusion matrices of `EKM` (left) and `DenseNet121` (right).', fid.width=800, fid.height=550, message=FALSE, warning=FALSE, paged.print=FALSE}
library(cowplot)
library(ggplot2)
...
```{r pca1, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 7.** The first ten principal directions of the PCA.", fid.width=800, fid.height=400, message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/PCA1.png")
```
```{r pca200, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 8.** Directions 200-210 of the PCA.",  fid.width=800, fid.height=400, message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/PCA200.png")
```
```{r variance, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 9.** Explained Variance.",  fid.width=550, fid.height=400, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r filters-ekm, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 13.** Three channels with some of the first 3x3 filters of the first hidden layer of the `EKM`.", fid.width=550, fid.height=460, message=FALSE, warning=FALSE, paged.print=FALSE}

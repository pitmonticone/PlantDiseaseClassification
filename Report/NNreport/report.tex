...
model output extract coarser, more abstract concepts.}, in FIG.\ref{fig:fm9},\ref{fig:fm6} and \ref{fig:fm2} we visualize a 4 x 4 matrix of subplots showing a sample of feature maps extracted from the first, the third and the fifth convolutional layer. 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Images/FeatureMaps0}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Images/FeatureMaps4}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Images/FeatureMaps8}

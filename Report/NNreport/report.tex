...
For more details see Platform Limitations.
...
layers of the network. See Model Architecture.
...
\begin{figure}
	...
	\caption{Confusion matrices of EKM (bottom) and DenseNet121 (top).}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Images/PCA1}
	\caption{The first ten principal directions of the PCA.}
	\label{fig:pca1}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Images/PCA200}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.75\linewidth]{Images/ExplainedVariance90}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Images/TrainingHistoryEKM}
	\caption{}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Images/TrainingHistoryDenseNet121}
	\caption{}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{Images/FiltersEKM}
	\caption{Three channels with some of the first 3x3 filters of the first hidden layer of the EKM.}
...
\begin{figure}%
	\centering
	{{\includegraphics[width=5cm]{Images/FeatureMaps2} }}%
	\qquad
	{{\includegraphics[width=5cm]{Images/FeatureMaps6} }}%
	\qquad
	{{\includegraphics[width=5cm]{Images/FeatureMaps9} }}%
	\caption{}%
	\label{fig:example}%
\end{figure}

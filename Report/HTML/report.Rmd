...
```{r input-images, echo=FALSE, fig.align='center', fig.cap="**FIGURE 1.** Sample of training images.", message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r pre-smote, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 2.** Pre-`SMOTE` truncated SVD.", message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r post-smote, echo=FALSE, fig.align='center', fig.cap="**FIGURE 3.** Post-`SMOTE` truncated SVD.", fig.width=200, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r confusion-matrices, echo=FALSE, fig.align='center', fig.cap='**FIGURE.** Confusion matrices of `EKM` (left) and `DenseNet121` (right).', message=FALSE, warning=FALSE, paged.print=FALSE}
library(cowplot)
library(ggplot2)
...
```{r ae-basenet, echo=FALSE, fig.align='center', fig.cap='**FIGURE.** Confusion matrices of `EKM` (left) and `DenseNet121` (right).', fig.width=80, message=FALSE, warning=FALSE, paged.print=FALSE}

include_graphics(c("Images/BaseNetShort.png","Images/AEShort.png"))
```
...
```{r variance, echo=FALSE, fig.align='center', fig.cap = "**Figure.** Layer 200-210 of PCA.", message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/ExplainedVariance90.png")
```

#### Convolutional Filters and Features Maps {#filters-featuremaps}

```{r filters-ekm, echo=FALSE, fig.align='center', fig.cap = "**FIGURE.** Three channels with some of the first 3x3 filters of the `EKM`.", message=FALSE, warning=FALSE, paged.print=FALSE}

...
```
```{r maps9, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 13.** Activation maps extracted from the fifth hidden layer of `EKM`.", message=FALSE, warning=FALSE, paged.print=FALSE}

...
# **Pipeline Description and Model Training**
...
### column-averaged ROC {#roc}
From [Challenge Overview](https://www.kaggle.com/c/plant-pathology-2020-fgvc7/overview/evaluation) on Kaggle:
>Submissions are evaluated on mean column-averaged ROC AUC. In other words, the score is the average of the individual AUCs of each predicted column.
...
![**Truncated SVD**. texttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttext](Images/TruncatedSVD.png)

![**Figure M.** Layer 1 of PCA.](Images/PCA1.png)

![**Figure M+1.** Layer 200 of PCA.](Images/PCA200.png)

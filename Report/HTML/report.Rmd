...
```
```{r maps2, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 14.** Activation maps extracted from the first convolutional layer of `EKM`.", message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/FeatureMaps9.png") 
# PAY ATTENTION: Maps2 is Maps9
```
```{r maps5, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 15.** Activation maps extracted from the third convolution layer of `EKM`.", message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics("Images/FeatureMaps6.png")
# PAY ATTENTION: Maps6 is Maps5
```
```{r maps9, echo=FALSE, fig.align='center', fig.cap = "**FIGURE 13.** Activation maps extracted from the fifth convolution layer of `EKM`.", message=FALSE, warning=FALSE, paged.print=FALSE}

...
```{r autoencoder, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, paged.print=FALSE}

include_graphics("/Users/pietromonticone/github/NeuralNetworksProject/Report/Images/AE.png")
```
...
include_graphics("/Users/pietromonticone/github/NeuralNetworksProject/Report/Images/BaseNet.png") 
```
